...
export type Vibe = keyof typeof VIBE_DESCRIPTORS;
export type Layout = keyof typeof LAYOUT_DESCRIPTORS;
export type Personality = keyof typeof PERSONALITY_DESCRIPTORS;
